...
export default function Register() {
  ...
  return (
    <div className="login-page register-page">
      ...
      <div
  className="login-image-container register-image"
  style={{
    backgroundImage: 'url("https://img.freepik.com/free-photo/wooden-table-looking-out-empty-restaurant_23-2147701318.jpg?uid=R171862940&ga=GA1.1.694180499.1730572632&semt=ais_hybrid")',
